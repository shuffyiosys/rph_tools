...
var ensureBlockTimer = setTimeout(reblockList, 60*1000);
    ...
    '<div id="settingsContainer" style="height: 470px; width: 100%; overflow: auto; background: rgb(51, 51, 51); padding: 10px; border-radius: 5px; font-size: 0.8em;">' +
     ...
     '<div id="diceForm" style="display:none;">' +
      ...
      '<div id="aboutHelpForm" style="display:none;">' +
        ...
        '<a href="https://openuserjs.org/scripts/shuffyiosys/RPH_Tools#troubleshooting" target=_blank">Troubleshooting Tips</a> | RPH Tools 2.1.4</p><br>' +
...
$(function() {
  ...
  _on('ignores', function(data) {
    console.log("RPH Tools[init]: Blocking user from servicing ignores", data.ids[0]);
  ...
  if (typeof(storage) != "undefined") {
    ...
    if (localStorage.getItem("blockedUsers") !== null) {
      ...
      for (var i = 0; i < temp_blockedUsers.length; i++) {
        console.log("RPH Tools[init]: Blocking user ", temp_blockedUsers[i]);
