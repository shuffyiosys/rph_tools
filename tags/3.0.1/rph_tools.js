...
var VERSION_STRING = 'RPH Tools 3.0.1';
...
var ChatModule = (function (){
    ...
    ****************************************************************************/
    var MatchPing = function(msg) {
        var testRegex = null;
        var pingNames = pingSettings.triggers.split(',');
        var regexParam = (pingSettings.case ? "m" : 'im');
        if (pingSettings.triggers.length === 0){
            return textRegex;
        }
    ...
    ****************************************************************************/
    var HighlightRoom = function(thisRoom) {
    ...
    ****************************************************************************/
            ...
            if (waitForDialog === true){
                ...
                if (chatSettings.session){
                    for(var i=0; i < chatSettings.roomSession.length; i++){
                        ...
                        var canJoin = Xor(roomInFavs,userInFavs) || chatSettings.autoJoin;
    ...
    var LoadSettings = function(storedSettings){
        ...
        console.log('Ping settings:', pingSettings);
    ...
    **************************************************************************/
    ...
    var GetSettings = function(){
        return {'chatSettings' : chatSettings, 'pingSettings' : pingSettings};
    };
    ...
    return {
        init : function(){
            ...
            settingsDialog.chat.button.click({dialog: settingsDialog.chat}, DialogToggle);
    ...
    **************************************************************************/
    ...
    return {
        init : function(){
            ...
            settingsDialog.pm.button.click({dialog: settingsDialog.pm}, DialogToggle);
    ...
    **************************************************************************/
    ...
    return {
        init : function(){
            ...
            settingsDialog.rng.button.click({dialog: settingsDialog.rng}, DialogToggle);
    ...
    ************************************************************************/
    ...
    return {
        init : function(){
            ...
            settingsDialog.blocking.button.click({dialog: settingsDialog.blocking}, DialogToggle);
    ...
    ****************************************************************************/
    ...
    return {
        init : function(){
            ...
            settingsDialog.modding.button.click({dialog: settingsDialog.modding}, DialogToggle);
    ...
    ****************************************************************************/
    ...
    return {
        init : function(){
            ...
            settingsDialog.settings.button.click({dialog: settingsDialog.settings}, DialogToggle);
...
var AboutModule = (function(){
    ...
    return {
        init : function(){
            ...
            settingsDialog.about.button.click({dialog: settingsDialog.about}, DialogToggle);
        },
    ...
    ****************************************************************************/
    ...
    return {
        init : function(addonModules){
            ...
            settingsDialog.dialog.button.click({dialog: settingsDialog.dialog, onClose: DialogCloseEvt}, DialogToggle);
